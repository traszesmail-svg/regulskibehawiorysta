...
- 17.09 (Opcja 2 - Połączenie łączone na żywo): Zrealizowano przepływ połączenia łączonego: przy rezerwacji generowany jest SMS informacyjny na numer klienta (+48505848889: "Dzień dobry! Za chwilę nastąpi połączenie z behawiorystą Krzysztofem Regulskim. Prosimy o odebranie telefonu."), a fizyczne połączenie głosowe z modemu SIM Motoroli kierowane jest bezpośrednio na prywatny telefon behawiorysty (+48579163241). Test na żywo w sieci T-Mobile potwierdził: wysyłkę SMS do klienta, odczyt briefingu sprawy przez lektora TTS oraz skuteczne zestawienie połączenia komórkowego (stan `mCallState=2` CALL_STATE_OFFHOOK).
- 17.09 (Opcja 3 - Tryb autonomiczny Daily Ops): Motorola One Vision (bateria 100%, stałe zasilanie USB) pozostawiona w trybie pracy ciągłej z aktywną usługą Foreground Service `SmsQueueService` (odpytywanie i meldunki co 60 sekund). System w pełni gotowy do autonomicznej pracy operacyjnej.
