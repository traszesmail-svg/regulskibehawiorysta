...
- 17.09 (Opcja 3 - Tryb ciągły): `SmsQueueService` działa jako foreground service po ręcznym uruchomieniu i odpyta kolejkę co 60 sekund. Nie ma jeszcze odbiornika startu po restarcie telefonu, więc nie można uznać autonomicznej pracy po aktualizacji lub restarcie za potwierdzoną.
