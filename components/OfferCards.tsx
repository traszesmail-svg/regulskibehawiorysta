...
const offers: Offer[] = [
  ...
  },
  {
    ...
    features: ['wariant pilny', 'najbliższy termin', 'ten sam zakres'],
  ...
  },
  {
    ...
    price: '470 zł',
    desc: 'Około 2h online dla spraw złożonych: diagnoza, prawdopodobna przyczyna problemu, plan działania i 7 dni wsparcia przez WhatsApp.',
