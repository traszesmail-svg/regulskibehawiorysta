...
export const LEAD_MAGNETS: LeadMagnet[] = [
  {
    ...
    followUpBody: 'Jeśli po materiale nadal nie wiesz, czy problemem jest ruch, pobudzenie czy odpoczynek, Zapytaj behawiorystę pomoże ustalić priorytet.',
  ...
  },
  {
    ...
    followUpBody: 'Jeśli po materiale nadal nie wiesz, co napędza zachowanie kota, Zapytaj behawiorystę pomoże ustalić kolejność zmian.',
  ...
  },
  {
    ...
    followUpBody: 'Jeśli lista pokazała kilka wątków naraz, Zapytaj behawiorystę pomoże ustalić pierwszy priorytet.',
  ...
  },
  {
    ...
    followUpBody: 'Jeśli adaptacja utknęła albo kot wycofuje się mocniej, Zapytaj behawiorystę pomoże ustalić bezpieczny kolejny krok.',
    nextStepCopy: 'Najbliższy kolejny krok prowadzi do strony o kotach albo do krótkiej rozmowy.',
    nextStepHref: '/problemy#kot',
    categoryHref: '/problemy#kot',
    categoryLabel: 'Koty',
  ...
  },
  {
    ...
    followUpBody: 'Jeśli po materiale nadal nie wiesz, czy to panika, frustracja czy przeciążenie, Zapytaj behawiorystę pomoże ustalić pierwszy bezpieczny krok.',
