...
export const FUNNEL_SERVICE_CONFIG: Record<AnyBookingServiceType, FunnelServiceConfig> = {
  ...
  'konsultacja-behawioralna-online': {
    ...
    mode: 'online',
    slotSpan: 6,
    slotSummary: 'Pełna konsultacja: około 2h online, analiza zachowania, prawdopodobna przyczyna problemu, plan działania i 7 dni wsparcia przez WhatsApp.',
    slotBadge: 'ok. 2h online',
    roomSummary: 'Pełna konsultacja: około 2h online, analiza zachowania, prawdopodobna przyczyna problemu, plan działania i 7 dni wsparcia przez WhatsApp.',
    publicSummary:
      'Około 2h online dla spraw złożonych: analiza zachowania, prawdopodobna przyczyna problemu, plan działania i 7 dni wsparcia przez WhatsApp przy wdrażaniu zaleceń.',
