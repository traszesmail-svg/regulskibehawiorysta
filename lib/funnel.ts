...
export const FUNNEL_SERVICE_CONFIG: Record<AnyBookingServiceType, FunnelServiceConfig> = {
  ...
  'kwadrans-na-juz': {
    ...
    mode: 'audio',
    slotSpan: 1,
    slotSummary: 'Kwadrans na już: ten sam zakres co Kwadrans, ale z najbliższym możliwym terminem. Dla spraw pilnych, które nie wymagają dłuższej analizy.',
    slotBadge: 'teraz / 15 min',
    roomSummary: 'Kwadrans na już: ten sam zakres co Kwadrans, ale z najbliższym możliwym terminem. Dla spraw pilnych, które nie wymagają dłuższej analizy.',
    publicSummary: 'Ten sam zakres co Kwadrans, ale z najbliższym możliwym terminem. Dla spraw pilnych, które nie wymagają dłuższej analizy.',
  ...
  'konsultacja-behawioralna-online': {
    ...
    mode: 'online',
    slotSpan: 6,
    slotSummary: 'Pełna konsultacja: około 2h online, diagnoza, prawdopodobna przyczyna problemu, plan działania i 7 dni wsparcia przez WhatsApp.',
    slotBadge: 'ok. 2h online',
    roomSummary: 'Pełna konsultacja: około 2h online, diagnoza, prawdopodobna przyczyna problemu, plan działania i 7 dni wsparcia przez WhatsApp.',
    publicSummary:
      'Około 2h online dla spraw złożonych: diagnoza, prawdopodobna przyczyna problemu, plan działania i 7 dni wsparcia przez WhatsApp przy wdrażaniu zaleceń.',
