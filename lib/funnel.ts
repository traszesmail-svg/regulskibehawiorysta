...
export const FUNNEL_CTA_LABELS = {
  ...
  consultation: 'Zobacz pełną konsultację',
...
export const FUNNEL_SERVICE_CONFIG: Record<AnyBookingServiceType, FunnelServiceConfig> = {
  'szybka-konsultacja-15-min': {
    ...
    durationMinutes: 15,
    durationLabel: 'do 15 minut telefonicznie',
    priceAmount: PUBLIC_SERVICE_PRICE_AMOUNTS['szybka-konsultacja-15-min'],
    pricePrefix: null,
    mode: 'phone',
    slotSpan: 1,
    slotSummary: 'Zapytaj behawiorystę: rozmowa telefoniczna do 15 minut. Opowiadasz, co się dzieje, i dostajesz pierwszy kierunek działania.',
    slotBadge: 'do 15 min telefonicznie',
    roomSummary: 'Zapytaj behawiorystę: rozmowa telefoniczna do 15 minut. Dostajesz pierwszy kierunek działania i dwa pytania po rozmowie.',
    publicSummary: 'Rozmowa telefoniczna do 15 minut. Dostajesz pierwszy kierunek działania i dwa pytania po rozmowie.',
    bookingLead: 'Wybierz gatunek, temat i dogodny termin rozmowy. Nie musisz znać nazwy problemu.',
  ...
  'kwadrans-na-juz': {
    ...
    mode: 'phone',
    slotSpan: 1,
    slotSummary: 'Zapytaj teraz: ten sam zakres co zwykłe Zapytaj behawiorystę, ale w najbliższym dostępnym oknie telefonicznym.',
    slotBadge: 'teraz / do 15 min telefonicznie',
    roomSummary: 'Zapytaj teraz: ten sam zakres co zwykłe Zapytaj behawiorystę, ale w najbliższym dostępnym oknie telefonicznym.',
    publicSummary: 'Ten sam zakres co Zapytaj behawiorystę, dostępny tylko wtedy, gdy ręcznie włączę najbliższe okno.',
    ...
    noAvailabilityMessage: 'Jeśli teraz nie mam wolnego okienka, wybierz zwykły termin albo zostaw kontakt do powiadomienia.',
    limitedAvailabilityNote: 'Opcja pojawia się wyłącznie podczas ręcznie włączonej dostępności.',
  },
  'konsultacja-30-min': {
    ...
    durationMinutes: 30,
    durationLabel: 'wariant historyczny',
    priceAmount: PUBLIC_SERVICE_PRICE_AMOUNTS['konsultacja-30-min'],
    pricePrefix: null,
    mode: 'phone',
    slotSpan: 2,
    slotSummary: 'Starszy wariant rozmowy zachowany wyłącznie dla istniejących danych i zgodności technicznej.',
    slotBadge: 'wariant historyczny',
    roomSummary: 'Starszy wariant rozmowy zachowany wyłącznie dla istniejących danych i zgodności technicznej.',
    publicSummary: 'Ten wariant nie jest obecnie dostępny w ofercie publicznej.',
    bookingLead: 'Ten wariant nie jest obecnie dostępny w ofercie publicznej.',
    availabilityLabel: 'Ten wariant nie jest obecnie dostępny.',
    noAvailabilityMessage: 'Wybierz Zapytaj behawiorystę albo zapoznaj się z pełną konsultacją.',
    limitedAvailabilityNote: null,
  },
  'konsultacja-behawioralna-online': {
    ...
    durationMinutes: 90,
    durationLabel: 'około 90 minut przez Jitsi',
    ...
    noAvailabilityMessage:
      'Pełna konsultacja jest dostępna indywidualnie po wcześniejszym Zapytaj behawiorystę. Jeśli nie masz jeszcze rekomendacji, zacznij od pierwszej rozmowy.',
    limitedAvailabilityNote: 'Terminy są udostępniane indywidualnie po pierwszym kroku.',
  },
}
