...
export const OFFERS: Offer[] = [
  ...
  },
  {
    ...
    nextStep: 'Umawiasz pełną konsultację online. Po rozmowie dostajesz analizę zachowania, prawdopodobną przyczynę problemu, plan działania i 7 dni wsparcia przez WhatsApp przy wdrażaniu zaleceń.',
    cardSummary: 'Około 2h online: analiza zachowania, prawdopodobna przyczyna problemu, plan działania i 7 dni wsparcia przez WhatsApp.',
    heroSummary: 'Około 2h online dla spraw złożonych: analiza zachowania, prawdopodobna przyczyna problemu, plan działania i 7 dni wsparcia przez WhatsApp przy wdrażaniu zaleceń.',
    descriptions: [
      'To format dla sytuacji, w których szybki start byłby zbyt płytki: problem wraca, narasta albo dotyka kilku rzeczy naraz.',
      'Po rozmowie dostajesz analizę zachowania, prawdopodobną przyczynę problemu, plan działania i 7 dni wsparcia przez WhatsApp przy wdrażaniu zaleceń.',
    ],
    ...
    outcomes: ['analiza zachowania i prawdopodobna przyczyna problemu', 'plan działania po rozmowie', '7 dni wsparcia przez WhatsApp przy wdrażaniu zaleceń'],
