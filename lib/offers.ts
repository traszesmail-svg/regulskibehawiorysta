...
export const OFFERS: Offer[] = [
  ...
  },
  {
    ...
    nextStep: 'Umawiasz pełną konsultację online. Po rozmowie dostajesz analizę zachowania, prawdopodobną przyczynę problemu, plan działania i 14 dni wsparcia przez WhatsApp przy wdrażaniu zaleceń. Pokój przechowuje podsumowanie i historię.',
    cardSummary: 'Około 90 minut online: analiza zachowania, prawdopodobna przyczyna problemu, plan działania i 14 dni wsparcia przez WhatsApp. Podsumowanie i historia zostają w Pokoju.',
    heroSummary: 'Około 90 minut online dla spraw złożonych: analiza zachowania, prawdopodobna przyczyna problemu, plan działania i 14 dni wsparcia przez WhatsApp przy wdrażaniu zaleceń. Pokój przechowuje podsumowanie i historię.',
    descriptions: [
      'To format dla sytuacji, w których szybki start byłby zbyt płytki: problem wraca, narasta albo dotyka kilku rzeczy naraz.',
      'Po rozmowie dostajesz analizę zachowania, prawdopodobną przyczynę problemu, plan działania i 14 dni wsparcia przez WhatsApp przy wdrażaniu zaleceń. Pokój przechowuje podsumowanie i historię.',
    ],
    ...
    outcomes: ['analiza zachowania i prawdopodobna przyczyna problemu', 'plan działania po rozmowie', '14 dni wsparcia przez WhatsApp przy wdrażaniu zaleceń; podsumowanie i historia w Pokoju'],
