...
export const OFFERS: Offer[] = [
  {
    ...
    descriptions: [
      ...
      'Po rozmowie masz diagnozę behawioralną opartą na zebranych informacjach i wiesz, czy wystarczy ten pierwszy krok, czy lepiej przejść do Dwóch kwadransów albo Pełnej konsultacji.',
    ],
  ...
  },
  {
    ...
    cardSummary: 'Ten sam zakres co Kwadrans, ale z najbliższym możliwym terminem. Dla spraw pilnych, które nie wymagają dłuższej analizy.',
    heroSummary: 'Ten sam zakres co Kwadrans, ale z najbliższym możliwym terminem. Dla spraw pilnych, które nie wymagają dłuższej analizy.',
    descriptions: [
    ...
    outcomes: ['diagnoza behawioralna oparta na informacjach bez czekania na zwykły termin', 'ten sam format 15 minut co w Kwadransie', 'jasna decyzja, czy potrzebny jest kolejny krok'],
    ...
    imageWidth: SPECIALIST_WIDE_PHOTO.width,
    imageHeight: SPECIALIST_WIDE_PHOTO.height,
    note: 'To ten sam zakres co Kwadrans za 69 zł. Różnica dotyczy najbliższego możliwego terminu, nie dłuższej analizy.',
  },
  {
    ...
    note: 'Dobry wybór, gdy 15 minut to za mało, ale temat nie wymaga jeszcze około 2h pełnej konsultacji i 7 dni wsparcia WhatsApp.',
  },
  {
    ...
    nextStep: 'Umawiasz pełną konsultację online. Po rozmowie dostajesz diagnozę, prawdopodobną przyczynę problemu, plan działania i 7 dni wsparcia przez WhatsApp przy wdrażaniu zaleceń.',
    cardSummary: 'Około 2h online: diagnoza, prawdopodobna przyczyna problemu, plan działania i 7 dni wsparcia przez WhatsApp.',
    heroSummary: 'Około 2h online dla spraw złożonych: diagnoza, prawdopodobna przyczyna problemu, plan działania i 7 dni wsparcia przez WhatsApp przy wdrażaniu zaleceń.',
    descriptions: [
      'To format dla sytuacji, w których szybki start byłby zbyt płytki: problem wraca, narasta albo dotyka kilku rzeczy naraz.',
      'Po rozmowie dostajesz diagnozę, prawdopodobną przyczynę problemu, plan działania i 7 dni wsparcia przez WhatsApp przy wdrażaniu zaleceń.',
    ],
    bestFor: ['temat złożony', 'kilka wątków naraz', 'gdy potrzebujesz diagnozy behawioralnej, etiologii i codziennego wsparcia wdrożenia'],
    outcomes: ['diagnoza i prawdopodobna przyczyna problemu', 'plan działania po rozmowie', '7 dni wsparcia przez WhatsApp przy wdrażaniu zaleceń'],
