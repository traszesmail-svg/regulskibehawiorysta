...
export const PUBLIC_OFFER_FAQ_ITEMS: TrustFaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Około 2h online audio albo audio/video, diagnozę, prawdopodobną przyczynę problemu, plan działania i 7 dni wsparcia przez WhatsApp przy wdrażaniu zaleceń. W tym czasie można zadawać pytania, wysyłać filmy i konsultować kolejne kroki.',
  },
  {
