...
export const pageSeo: Record<string, PageSeo> = {
  ...
  '/cennik': {
    ...
    description: `Zapytaj behawiorystę ${PUBLIC_OFFER_PRICE_LABELS.quick}, Zapytaj teraz ${PUBLIC_OFFER_PRICE_LABELS.urgent}, Pełna konsultacja ${PUBLIC_OFFER_PRICE_LABELS.premium}. Wybierz pierwszy krok dopasowany do sytuacji.`,
  ...
  '/cennik/pelny': {
    ...
    description: `Oferta rozmów: Zapytaj behawiorystę ${PUBLIC_OFFER_PRICE_LABELS.quick}, Zapytaj teraz ${PUBLIC_OFFER_PRICE_LABELS.urgent} i Pełna konsultacja ${PUBLIC_OFFER_PRICE_LABELS.premium}.`,
    keywords: ['pełny cennik behawiorysta', 'cena konsultacji behawioralnej', 'zapytaj behawiorystę cena'],
    priority: 0.8,
    changefreq: 'monthly',
  },
  '/book': {
    title: 'Umów spokojny pierwszy krok | Regulski',
    description: 'Wybierz pierwszy krok z behawiorystą. Zapytaj behawiorystę odbywa się telefonicznie, a pełna konsultacja jest udostępniana indywidualnie po rozmowie.',
