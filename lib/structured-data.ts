...
export function localBusinessSchema() {
  return {
    ...
    hasOfferCatalog: {
      ...
      itemListElement: [
        { '@type': 'Offer', name: 'Zapytaj behawiorystę', price: String(PUBLIC_SERVICE_PRICE_AMOUNTS['szybka-konsultacja-15-min']), priceCurrency: 'PLN' },
        { '@type': 'Offer', name: 'Zapytaj teraz', price: String(PUBLIC_SERVICE_PRICE_AMOUNTS['kwadrans-na-juz']), priceCurrency: 'PLN' },
      ...
      itemListElement: [
        {
          ...
          description: 'Rozmowa telefoniczna do 15 minut, pierwszy kierunek działania i dwa pytania po rozmowie',
        ...
        },
        {
          '@type': 'Offer',
          name: 'Zapytaj teraz',
          description: 'Ten sam zakres co Zapytaj behawiorystę, gdy ręcznie włączona jest dostępność na najbliższe okno',
