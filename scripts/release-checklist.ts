...
const REQUIRED_PACKAGE_SCRIPTS: Record<string, string> = {
  ...
  test: 'node --import tsx --test tests/runtime-config.test.ts tests/customer-emails.test.ts tests/funnel-metrics.test.ts tests/booking-api-errors.test.ts tests/scheduling-rules.test.ts',
