  ...
  try {
    ...
    await withEnv(
      ...
      async () => {
        ...
        assert.match(sentEmails[3].html ?? '', /Wejdź do pokoju rozmowy/)
        ...
        assert.match(sentEmails[4].html ?? '', /Otwórz pokój rozmowy/)
        assert.match(sentEmails[4].html ?? '', /Dodaj do Google Calendar/)
